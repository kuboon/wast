...
| compiler | `crates/compiler/` | **v0.30 done** (heterogeneous MatchVariant i32/i64) | implicit widen → heterogeneous memory copy → f/i reinterpret |
...
- [ ] Roadmap: implicit widen (LocalGet in wider context) → heterogeneous memory copy (emit_copy_from_local disc branch) → f/i reinterpret
