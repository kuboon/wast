...
| compiler | `crates/compiler/` | **v0.21 done** (ListLiteral: runtime list construction) | resource → deeper nested compound |
...
- [ ] Roadmap: `resource` → deeper nested compound (record-of-record, option<record>, etc.)
