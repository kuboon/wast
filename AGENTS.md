...
| compiler | `crates/compiler/` | **v0.24 done** (LocalGet of compound in field position) | imported resource → variant/option/result LocalGet copy → heterogeneous join |
...
- [ ] Roadmap: imported resource → variant/option/result LocalGet copy → heterogeneous join
