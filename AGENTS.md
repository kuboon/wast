...
| compiler | `crates/compiler/` | **v0.9 done** (+ MatchOption/MatchResult, destructure bindings) | string/list |
...
- [ ] Roadmap: `string` (ptr+len with memcpy via bulk-memory) → `list<T>` → `record/variant/tuple/resource`
