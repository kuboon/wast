...
| compiler | `crates/compiler/` | **v0.18 done** (+ `tuple<T1,T2,…>` with TupleGet/TupleLiteral) | flags/enum → nested compound → resource |
...
- [ ] Roadmap: `flags/enum` → nested compound (record-of-string etc.) → `resource`
