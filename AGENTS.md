...
| compiler | `crates/compiler/` | **v0.28 done** (imported resource) | heterogeneous result/variant |
...
- [ ] Roadmap: heterogeneous result/variant (layout differs per case — flat join extend/truncate + memory disc branch)
