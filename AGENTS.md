...
| compiler | `crates/compiler/` | **v0.23 done** (resource constructor + method + static + dtor, end-to-end) | imported resource → LocalGet of nested compound |
...
- [ ] Roadmap: imported resource (another component defines it, we consume) → LocalGet of nested compound
