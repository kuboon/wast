...
| compiler | `crates/compiler/` | **v0.29 done** (heterogeneous result i32/i64 at MatchResult) | MatchVariant hetero → implicit widen → heterogeneous memory copy |
...
- [ ] Roadmap: MatchVariant hetero → implicit widen (LocalGet in wider context) → heterogeneous memory copy (emit_copy_from_local disc branch) → f/i reinterpret
