...
| compiler | `crates/compiler/` | **v0.20 done** (nested compound: string/list fields in record/tuple/variant) | ListLiteral → resource |
...
- [ ] Roadmap: `ListLiteral` (runtime list construction) → `resource`
