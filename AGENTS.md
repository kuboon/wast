...
| compiler | `crates/compiler/` | **v0.26 done** (option&lt;T&gt; multi-slot flat + LocalGet copy) | imported resource → heterogeneous join → result/variant multi-slot copy |
...
- [ ] Roadmap: imported resource → heterogeneous join → result/variant multi-slot copy
