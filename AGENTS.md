...
| compiler | `crates/compiler/` | **v0.27 done** (result/variant homogeneous multi-slot copy) | imported resource → heterogeneous result/variant |
...
- [ ] Roadmap: imported resource → heterogeneous result/variant (layout differs per case)
