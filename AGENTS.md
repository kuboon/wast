...
| compiler | `crates/compiler/` | **v0.23 done** (resource constructor + method, end-to-end) | resource 拡張 (static/dtor/imported) → LocalGet of nested compound |
